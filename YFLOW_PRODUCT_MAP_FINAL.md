# YFLOW_PRODUCT_MAP_FINAL.md - مع سبير بنك الروسي فقط
...
**Обновление**: Добавлена поддержка Sberbank (Россия) для платежной системы. SPIBank удален.
...
| | packages/server/api/src/app/ee/platform/platform-plan/stripe-helper.ts | Stripe хелперы | ОСТОРОЖНО | Оставить как есть |
...
10. **Финальная проверка:**
    ...
    # Тестировать 3 платежные системы
    ```
...
YFlow теперь поддерживает 3 платежные системы:
1. **Stripe** - международные платежи
2. **YooKassa** - российские платежи (нужно реализовать)
3. **Sberbank** - российские платежи (реализовано ✅)

**Удалено:**
- ❌ SPIBank (саудовские платежи) - удален по запросу

Платформа готова к white-label развертыванию с поддержкой международных и российских платежных систем.

## 14. الميزات الرئيسية

- 🇷🇺 **دعم الروبل الروسي** عبر Sberbank
- 💳 **دفعات لمرة واحدة** واشتراكات شهرية/سنوية
- 🔒 **تواقيع آمنة** للـ webhooks
- 🔄 **تجديد تلقائي** للاشتراكات
- 🎯 **متوافق مع هيكلة YFlow** الحالية
- 🌍 **متعدد العملات** - USD, EUR, RUB
