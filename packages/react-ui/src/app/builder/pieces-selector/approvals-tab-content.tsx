...
import { FlowActionType, FlowOperationType, isNil } from '@yflow/shared';
...
const APPROVAL_PIECES_CONFIG = [
  ...
  {
    pieceName: '@yflow/piece-discord',
    approvalActionNames: ['request_approval_message'],
  },
  {
    pieceName: '@yflow/piece-microsoft-teams',
    approvalActionNames: [
      'request_approval_direct_message',
  ...
  {
    pieceName: '@yflow/piece-microsoft-outlook',
