...
import { ApFlagId } from '@yflow/shared';
  ...
  const technicalChecks = [
    {
              ...
              <>
                ...
                <span>
                  ...
                  <a
                    ...
                    href="https://github.com/yflow/yflow/releases"
                    target="_blank"
      ...
      link: 'https://github.com/yflow/yflow/releases',
    },
    {
      id: 'disk-size',
      title: t('Disk Size'),
      ...
      message: (
        <span>
          {systemHealth?.disk
            ...
            : t(
                'Insufficient disk space. A minimum of 30GB is required for Yflowto function properly.',
              )}
        </span>
      ),
      loading: isPending,
      link: 'https://www.yflow.com/docs/install/configuration/hardware#technical-specifications',
    },
    {
      id: 'ram',
      title: t('RAM'),
    ...
    },
    {
      ...
      message: (
        <span>
          {systemHealth?.cpu
            ? t(
                'The server has enough CPU resources. At least 1 CPU core is required to run yflow.',
              )
            : t(
                'Not enough CPU resources. At least 1 CPU core is necessary to operate yflow.',
              )}
        </span>
      ),
      link: 'https://www.yflow.com/docs/install/configuration/hardware#technical-specifications',
