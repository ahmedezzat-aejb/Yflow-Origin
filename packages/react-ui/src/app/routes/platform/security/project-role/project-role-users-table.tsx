...
import { ProjectMemberWithUser } from '@yflow/ee-shared';
import { assertNotNullOrUndefined, isNil } from '@yflow/shared';
...
export const ProjectRoleUsersTable = () => {
  ...
  return (
    <LockedFeatureGuard
      ...
      lockVideoUrl="https://cdn.yflow.com/videos/showcase/roles.mp4"
    >
