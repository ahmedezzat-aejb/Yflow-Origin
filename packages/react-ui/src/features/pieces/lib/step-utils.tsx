...
> = {
  [FlowActionType.CODE]: {
    displayName: t('Code'),
    logoUrl: 'https://cdn.yflow.com/pieces/new-core/code.svg',
  ...
  [FlowActionType.LOOP_ON_ITEMS]: {
    ...
    logoUrl: 'https://cdn.yflow.com/pieces/new-core/loop.svg',
    description: 'Iterate over a list of items',
    type: FlowActionType.LOOP_ON_ITEMS as const,
  },
  [FlowActionType.ROUTER]: {
    displayName: t('Router'),
    logoUrl: 'https://cdn.yflow.com/pieces/new-core/router.svg',
  ...
  [FlowTriggerType.EMPTY]: {
    ...
    logoUrl: 'https://cdn.yflow.com/pieces/new-core/empty-trigger.svg',
