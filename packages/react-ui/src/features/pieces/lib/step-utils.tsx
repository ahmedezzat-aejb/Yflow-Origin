...
> = {
  [FlowActionType.CODE]: {
    displayName: t('Code'),
    logoUrl: '/pieces/new-core/code.svg',
  ...
  [FlowTriggerType.EMPTY]: {
    ...
    logoUrl: '/pieces/new-core/empty-trigger.svg',
...
export const AI_ACTIONS_METADATA = [
  {
    displayName: 'Ask AI',
