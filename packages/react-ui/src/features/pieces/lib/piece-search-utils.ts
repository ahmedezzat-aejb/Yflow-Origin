...
const POPULAR_PIECES_NAMES = [
  '@yflow/piece-google-sheets',
  '@yflow/piece-slack',
  '@yflow/piece-notion',
  '@yflow/piece-gmail',
  '@yflow/piece-hubspot',
  '@yflow/piece-openai',
  '@yflow/piece-google-forms',
  '@yflow/piece-google-drive',
  '@yflow/piece-google-docs',
];
...
const HIGHLIGHTED_PIECES_NAMES_FOR_TRIGGERS = [
  '@yflow/piece-webhook',
  '@yflow/piece-schedule',
  '@yflow/piece-manual-trigger',
  '@yflow/piece-forms',
  '@yflow/piece-tables',
];
...
const HIGHLIGHTED_PIECES_NAMES_FOR_ACTIONS = [
  ...
  '@yflow/piece-forms',
  '@yflow/piece-webhook',
  '@yflow/piece-text-helper',
  '@yflow/piece-date-helper',
];
