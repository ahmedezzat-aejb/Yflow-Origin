import { apDayjsDuration, getPlatformPlanNameKey, getProjectMaxConcurrentJobsKey } from '@yflow/server-shared'
import { ApEdition, ExecuteFlowJobData, isNil, JobData, PlanName, PlatformId, ProjectId, RunEnvironment, WorkerJobType } from '@yflow/shared'
...
const PLAN_CONCURRENT_JOBS_LIMITS: Record<string, number> = {
    [PlanName.STANDARD]: 5,
    [PlanName.APPSUMO_yflow_TIER1]: 5,
    [PlanName.APPSUMO_yflow_TIER2]: 5,
    [PlanName.APPSUMO_yflow_TIER3]: 10,
    [PlanName.APPSUMO_yflow_TIER4]: 15,
    [PlanName.APPSUMO_yflow_TIER5]: 20,
    [PlanName.APPSUMO_yflow_TIER6]: 25,
