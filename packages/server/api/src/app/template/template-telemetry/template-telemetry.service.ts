...
import { ApEdition, isNil, TemplateTelemetryEvent, TemplateTelemetryEventType, tryCatch } from '@yflow/shared'
import { FastifyBaseLogger } from 'fastify'
import { system } from '../../helper/system/system'

const CLOUD_TELEMETRY_URL = 'https://cloud.yflow.com/api/v1/templates-telemetry'
const INTERNAL_TELEMETRY_URL = 'https://template-manager.yflow.com/api/public/analytics/event'
