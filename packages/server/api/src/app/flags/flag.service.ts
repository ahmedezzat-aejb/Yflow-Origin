import { AppSystemProp, apVersionUtil, webhookSecretsUtils } from '@yflow/server-shared'
import { ApEdition, ApFlagId, ExecutionMode, Flag, isNil } from '@yflow/shared'
    ...
    async getAll(): Promise<Flag[]> {
        ...
        flags.push(
            ...
            },
            {
                ...
                value: 'https://www.yflow.com/privacy',
                created,
                updated,
            },
            {
                id: ApFlagId.TERMS_OF_SERVICE_URL,
                value: 'https://www.yflow.com/terms',
                created,
                updated,
            },
            {
