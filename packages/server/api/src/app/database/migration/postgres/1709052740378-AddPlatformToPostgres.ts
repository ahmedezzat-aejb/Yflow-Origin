import { ApEdition, apId } from '@yflow/shared'
...
async function migrateProjects(queryRunner: QueryRunner) {
    ...
    for (const project of standaloneProjects) {
        ...
        await queryRunner.query(
            ...
            "showActivityLog")
            VALUES
            ($1, current_timestamp, current_timestamp, $2, 'yflow',
            '#6e41e2', 'https://cdn.yflow.com/brand/logo.svg',
            'https://cdn.yflow.com/brand/full-logo.png',
            'https://cdn.yflow.com/brand/favicon.ico', '{}',
