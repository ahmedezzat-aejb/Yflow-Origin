...
import { square } from '@yflow/piece-square'
import { Piece, PieceAuthProperty } from '@yflow/pieces-framework'
import {
...
const pieceNames: Record<string, string> = {
    slack: '@yflow/piece-slack',
    square: '@yflow/piece-square',
    'facebook-leads': '@yflow/piece-facebook-leads',
    intercom: '@yflow/piece-intercom',
}
