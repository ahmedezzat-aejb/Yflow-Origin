...
import { AppSystemProp, exceptionHandler } from '@yflow/server-shared'
import { apId, FileType, isNil, ProjectId } from '@yflow/shared'
...
export const s3Helper = (log: FastifyBaseLogger) => ({
    ...
    async validateS3Configuration(): Promise<void> {
        ...
        const testKey = `yflow-${apId()}-validation-test-key`
