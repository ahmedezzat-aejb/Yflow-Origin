import { APPSUMO_PLAN, STANDARD_CLOUD_PLAN } from '@yflow/ee-shared'
import { isNil, PlanName, PlatformPlanWithOnlyLimits, PlatformRole } from '@yflow/shared'
...
const appSumoPlans: Record<string, PlatformPlanWithOnlyLimits> = {
    yflow_tier1: APPSUMO_PLAN(PlanName.APPSUMO_yflow_TIER1),
    yflow_tier2: APPSUMO_PLAN(PlanName.APPSUMO_yflow_TIER2),
    yflow_tier3: APPSUMO_PLAN(PlanName.APPSUMO_yflow_TIER3),
    yflow_tier4: APPSUMO_PLAN(PlanName.APPSUMO_yflow_TIER4),
    yflow_tier5: APPSUMO_PLAN(PlanName.APPSUMO_yflow_TIER5),
    yflow_tier6: APPSUMO_PLAN(PlanName.APPSUMO_yflow_TIER6),
}
