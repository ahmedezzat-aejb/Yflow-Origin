import { ApplicationEvent, ApplicationEventName, FlowUpdatedEvent } from '@yflow/ee-shared'
import { BADGES, FlowActionType, FlowOperationType, flowStructureUtil, FlowTriggerType, isNil } from '@yflow/shared'
import { flowVersionRepo } from '../../../flows/flow-version/flow-version.service'
import { BadgeCheck, BadgeCheckResult } from '../badge-check'

const WEBHOOK_PIECE_NAME = '@yflow/piece-webhook'
const AI_PIECE_NAME = '@yflow/piece-ai'
