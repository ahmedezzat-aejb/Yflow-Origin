...
**Workspace URL**: The url of mattermost instance (e.g \`https://Yflow.mattermost.com\`)
...
export const mattermostAuth = PieceAuth.CustomAuth({
  ...
  props: {
    workspace_url: Property.ShortText({
      ...
      description:
        'The workspace URL of the Mattermost instance (e.g https://Yflow.mattermost.com)',
      required: true,
    }),
...
export const mattermost = createPiece({
  ...
  logoUrl: 'https://cdn.Yflow.com/pieces/mattermost.png',
