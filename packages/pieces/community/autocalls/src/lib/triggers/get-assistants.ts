import { createTrigger, TriggerStrategy, Property, AppConnectionValueForAuthProperty } from '@yflow/pieces-framework';
import { DedupeStrategy, Polling, pollingHelper, httpClient, HttpMethod } from '@yflow/pieces-common';
