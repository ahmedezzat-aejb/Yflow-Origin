import { httpClient, HttpMethod, AuthenticationType } from '@yflow/pieces-common';
import { AppConnectionValueForAuthProperty, PieceAuth } from '@yflow/pieces-framework';
