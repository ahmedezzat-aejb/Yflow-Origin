import { AppConnectionValueForAuthProperty, OAuth2PropertyValue, OAuth2Props, PieceAuth, PiecePropValueSchema, Property, ShortTextProperty, StaticPropsValue } from '@yflow/pieces-framework';
import {
	httpClient,
	HttpMethod,
	AuthenticationType,
...
import { AppConnectionType, isNil, isString } from '@yflow/shared';
