...
import { AppConnectionValueForAuthProperty, createPiece, PieceAuth } from '@yflow/pieces-framework';
...
import { AppConnectionType } from '@yflow/shared';
...
export const wufoo = createPiece({
  ...
  logoUrl: 'https://cdn.yflow.com/pieces/wufoo.png',
