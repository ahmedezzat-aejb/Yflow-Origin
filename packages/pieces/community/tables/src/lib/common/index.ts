import { AuthenticationType, httpClient, HttpMethod } from "@yflow/pieces-common";
import { DynamicPropsValue, PieceAuth, Property } from "@yflow/pieces-framework";
import { assertNotNullOrUndefined, CreateTableWebhookRequest, Field, FieldType, MarkdownVariant, PopulatedRecord, SeekPage, StaticDropdownEmptyOption, Table, TableWebhookEventType, ListTablesRequest } from "@yflow/shared";
import { z } from 'zod';
import qs from 'qs';
