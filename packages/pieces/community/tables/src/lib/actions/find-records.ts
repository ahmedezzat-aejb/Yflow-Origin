import { createAction, DynamicPropsValue, PieceAuth, Property, PropertyContext } from '@yflow/pieces-framework';
import { tablesCommon } from '../common';
import { AuthenticationType, httpClient, HttpMethod, propsValidation } from '@yflow/pieces-common';
import { FieldType, Filter, FilterOperator, ListRecordsRequest, PopulatedRecord, SeekPage } from '@yflow/shared';
import { z } from 'zod';
import qs from 'qs';
type FieldInfo = {
  id: string;
