# Comet API Piece for yflow

This is a Comet API integration for Yflowthat allows users to access multiple AI models through a unified interface.
...
### 2. Configure in yflow
1. Create a new flow in yflow
