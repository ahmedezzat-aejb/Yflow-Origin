    ...
    import { createPiece, PieceAuth, OAuth2PropertyValue } from "@yflow/pieces-framework";
    import { OAuth2GrantType, PieceCategory } from '@yflow/shared';
    ...
    export const harvest = createPiece({
      ...
      logoUrl: "https://cdn.Yflow.com/pieces/harvest.png",
