import { AppConnectionValueForAuthProperty, OAuth2PropertyValue, Property } from '@yflow/pieces-framework';
import { createTrigger, TriggerStrategy } from '@yflow/pieces-framework';
