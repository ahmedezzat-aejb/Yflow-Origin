import { Trigger } from '@yflow/pieces-framework';
...
export const registered = [
  {
    ...
    sampleData: {
      ...
      number: 2,
      pull_request: {
        url: 'https://api.github.com/repos/Yflow/Yflow/pulls/2',
        id: 1246014943,
        node_id: 'PR_kwDOCfU56M5KRK3f',
        html_url: 'https://github.com/Yflow/Yflow/pull/2',
        diff_url: 'https://github.com/Yflow/Yflow/pull/2.diff',
        patch_url: 'https://github.com/Yflow/Yflow/pull/2.patch',
        issue_url:
          'https://api.github.com/repos/Yflow/Yflow/issues/2',
        number: 2,
        state: 'open',
        locked: false,
        title: 'added',
        ...
        draft: false,
        commits_url:
          'https://api.github.com/repos/Yflow/Yflow/pulls/2/commits',
        review_comments_url:
          'https://api.github.com/repos/Yflow/Yflow/pulls/2/comments',
        review_comment_url:
          'https://api.github.com/repos/Yflow/Yflow/pulls/comments{/number}',
        comments_url:
          'https://api.github.com/repos/Yflow/Yflow/issues/2/comments',
        statuses_url:
          'https://api.github.com/repos/Yflow/Yflow/statuses/309b7842c3c8a7cd275a4a6da1e89713917bcdc6',
        head: {
          label: 'kanarelo:dd',
          ref: 'dd',
      ...
      repository: {
        ...
        html_url: 'https://github.com/Yflow/Yflow',
        description: 'Automate!',
        fork: false,
        url: 'https://api.github.com/repos/Yflow/Yflow',
        forks_url:
          'https://api.github.com/repos/Yflow/Yflow/forks',
        keys_url:
          'https://api.github.com/repos/Yflow/Yflow/keys{/key_id}',
        collaborators_url:
          'https://api.github.com/repos/Yflow/Yflow/collaborators{/collaborator}',
        teams_url:
          'https://api.github.com/repos/Yflow/Yflow/teams',
        hooks_url:
          'https://api.github.com/repos/Yflow/Yflow/hooks',
        issue_events_url:
          'https://api.github.com/repos/Yflow/Yflow/issues/events{/number}',
        events_url:
          'https://api.github.com/repos/Yflow/Yflow/events',
        assignees_url:
          'https://api.github.com/repos/Yflow/Yflow/assignees{/user}',
        branches_url:
          'https://api.github.com/repos/Yflow/Yflow/branches{/branch}',
        tags_url: 'https://api.github.com/repos/Yflow/Yflow/tags',
        blobs_url:
          'https://api.github.com/repos/Yflow/Yflow/git/blobs{/sha}',
        git_tags_url:
          'https://api.github.com/repos/Yflow/Yflow/git/tags{/sha}',
        git_refs_url:
          'https://api.github.com/repos/Yflow/Yflow/git/refs{/sha}',
        trees_url:
          'https://api.github.com/repos/Yflow/Yflow/git/trees{/sha}',
        statuses_url:
          'https://api.github.com/repos/Yflow/Yflow/statuses/{sha}',
        languages_url:
          'https://api.github.com/repos/Yflow/Yflow/languages',
        stargazers_url:
          'https://api.github.com/repos/Yflow/Yflow/stargazers',
        contributors_url:
          'https://api.github.com/repos/Yflow/Yflow/contributors',
        subscribers_url:
          'https://api.github.com/repos/Yflow/Yflow/subscribers',
        subscription_url:
          'https://api.github.com/repos/Yflow/Yflow/subscription',
        commits_url:
          'https://api.github.com/repos/Yflow/Yflow/commits{/sha}',
        git_commits_url:
          'https://api.github.com/repos/Yflow/Yflow/git/commits{/sha}',
        comments_url:
          'https://api.github.com/repos/Yflow/Yflow/comments{/number}',
        issue_comment_url:
          'https://api.github.com/repos/Yflow/Yflow/issues/comments{/number}',
        contents_url:
          'https://api.github.com/repos/Yflow/Yflow/contents/{+path}',
        compare_url:
          'https://api.github.com/repos/Yflow/Yflow/compare/{base}...{head}',
        merges_url:
          'https://api.github.com/repos/Yflow/Yflow/merges',
        archive_url:
          'https://api.github.com/repos/Yflow/Yflow/{archive_format}{/ref}',
        downloads_url:
          'https://api.github.com/repos/Yflow/Yflow/downloads',
        issues_url:
          'https://api.github.com/repos/Yflow/Yflow/issues{/number}',
        pulls_url:
          'https://api.github.com/repos/Yflow/Yflow/pulls{/number}',
        milestones_url:
          'https://api.github.com/repos/Yflow/Yflow/milestones{/number}',
        notifications_url:
          'https://api.github.com/repos/Yflow/Yflow/notifications{?since,all,participating}',
        labels_url:
          'https://api.github.com/repos/Yflow/Yflow/labels{/name}',
        releases_url:
          'https://api.github.com/repos/Yflow/Yflow/releases{/id}',
        deployments_url:
          'https://api.github.com/repos/Yflow/Yflow/deployments',
        created_at: '2019-01-22T20:57:01Z',
        updated_at: '2023-02-18T11:05:49Z',
        pushed_at: '2019-02-22T20:19:33Z',
        git_url: 'git://github.com/Yflow/Yflow.git',
        ssh_url: 'git@github.com/Yflow/Yflow.git',
        clone_url: 'https://github.com/Yflow/Yflow.git',
        svn_url: 'https://github.com/Yflow/Yflow',
        homepage: null,
        size: 6637,
        stargazers_count: 1,
        watchers_count: 1,
      ...
      sender: {
        ...
        gravatar_id: '',
        url: 'https://api.github.com/users/Yflow',
        html_url: 'https://github.com/Yflow',
        followers_url: 'https://api.github.com/users/Yflow/followers',
        following_url:
          'https://api.github.com/users/Yflow/following{/other_user}',
        gists_url: 'https://api.github.com/users/Yflow/gists{/gist_id}',
        starred_url:
          'https://api.github.com/users/Yflow/starred{/owner}{/repo}',
        subscriptions_url:
          'https://api.github.com/users/Yflow/subscriptions',
        organizations_url: 'https://api.github.com/users/Yflow/orgs',
        repos_url: 'https://api.github.com/users/Yflow/repos',
        events_url:
          'https://api.github.com/users/Yflow/events{/privacy}',
        received_events_url:
          'https://api.github.com/users/Yflow/received_events',
        type: 'User',
        site_admin: false,
      },
    },
      ...
      repository: {
        ...
        owner: {
          ...
          following_url:
            'https://api.github.com/users/Yflow/following{/other_user}',
          gists_url:
            'https://api.github.com/users/Yflow/gists{/gist_id}',
          starred_url:
            'https://api.github.com/users/Yflow/starred{/owner}{/repo}',
          subscriptions_url:
            'https://api.github.com/users/Yflow/subscriptions',
  ...
  },
  {
    ...
    sampleData: {
      action: 'opened',
      issue: {
        url: 'https://api.github.com/repos/Yflow/Yflow/issues/1',
        repository_url:
          'https://api.github.com/repos/Yflow/Yflow',
        labels_url:
          'https://api.github.com/repos/Yflow/Yflow/issues/1/labels{/name}',
        comments_url:
          'https://api.github.com/repos/Yflow/Yflow/issues/1/comments',
        events_url:
          'https://api.github.com/repos/Yflow/Yflow/issues/1/events',
        html_url: 'https://github.com/Yflow/Yflow/issues/1',
        id: 1590311655,
        ...
        body: 'Test',
        reactions: {
          url: 'https://api.github.com/repos/Yflow/Yflow/issues/1/reactions',
          total_count: 0,
          '+1': 0,
          '-1': 0,
          laugh: 0,
        ...
        timeline_url:
          'https://api.github.com/repos/Yflow/Yflow/issues/1/timeline',
