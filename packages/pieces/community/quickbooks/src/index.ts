import { createPiece, OAuth2PropertyValue, PieceAuth, PiecePropValueSchema, Property } from "@yflow/pieces-framework";
...
export const quickbooks = createPiece({
  ...
  logoUrl: "https://cdn.yflow.com/pieces/quickbooks.png",
  authors: [
    'onyedikachi-david'
  ],
  actions: [
