import { createTrigger, Property, TriggerStrategy } from '@yflow/pieces-framework';
...
export const newDocumentProcessed = createTrigger({
  ...
  props: {
    webhookInstructions: Property.MarkDown({
      value: `
To use this trigger, you need to manually set up a single webhook endpoint in your Extracta.ai account. This endpoint will receive all events, and Yflowwill filter for the correct one.
...
This single webhook will now send all events to yflow. This trigger will only activate for the **'extraction.processed'** event.
      `,
    }),
  },
  sampleData: {
