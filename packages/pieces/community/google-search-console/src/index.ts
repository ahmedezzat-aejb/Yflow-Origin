import { createPiece, OAuth2PropertyValue, PieceAuth } from '@yflow/pieces-framework';
...
export const googleSearchConsoleAuth = PieceAuth.OAuth2({
  ...
  12. Add https://cloud.Yflow.com/redirect in **Authorized redirect URIs** field, and click on the Create button.
...
export const googleSearchConsolePiece = createPiece({
  ...
  logoUrl: 'https://cdn.Yflow.com/pieces/google-search-console.png',
