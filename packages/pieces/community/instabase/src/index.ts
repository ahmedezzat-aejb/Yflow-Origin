...
import { PieceAuth, createPiece, Property } from "@yflow/pieces-framework";
import { PieceCategory } from '@yflow/shared';
import { HttpMethod, httpClient, AuthenticationType } from '@yflow/pieces-common';
...
export const instabase = createPiece({
  ...
  logoUrl: "https://cdn.Yflow.com/pieces/instabase.png",
