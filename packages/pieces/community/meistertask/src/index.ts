...
import { OAuth2PropertyValue } from '@yflow/pieces-framework';
import { httpClient, HttpMethod, AuthenticationType, createCustomApiCallAction } from '@yflow/pieces-common';
...
export const meistertask = createPiece({
  ...
  logoUrl: 'https://cdn.Yflow.com/pieces/meistertask.png',
