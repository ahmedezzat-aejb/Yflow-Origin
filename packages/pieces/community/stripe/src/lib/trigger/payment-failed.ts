import { createTrigger } from '@yflow/pieces-framework';
import { TriggerStrategy } from '@yflow/pieces-framework';
...
export const stripePaymentFailed = createTrigger({
  ...
  sampleData: {
    ...
    calculated_statement_descriptor: 'WWW.yflow.COM',
    captured: false,
    created: 1675181413,
    currency: 'usd',
    ...
    statement_descriptor: 'www.yflow.com',
