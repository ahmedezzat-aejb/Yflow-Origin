...
import { httpClient, HttpMethod, createCustomApiCallAction } from '@yflow/pieces-common';
...
export const bookedinAuth = PieceAuth.SecretText({
  ...
  description: `To connect your Bookedin account, please follow these steps to retrieve your API Key:
    ...
    Your API Key allows Yflowto securely access your Bookedin leads, agents, and booking data.
    `,
  validate: async ({ auth }) => {
    try {
...
export const bookedin = createPiece({
  ...
  logoUrl: 'https://cdn.yflow.com/pieces/bookedin.png',
