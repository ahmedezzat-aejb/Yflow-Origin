...
import { HttpMethod, HttpRequest, httpClient } from '@yflow/pieces-common';
...
6. Enter a name for your token (e.g., "YflowIntegration").
...
export const smartsheet = createPiece({
	...
	logoUrl: 'https://cdn.yflow.com/pieces/smartsheet.png',
