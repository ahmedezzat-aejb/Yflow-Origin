...
4. The public and secret API keys are now displayed, copy them one by one into the right Yflowfields.
`;
...
export const generatebanners = createPiece({
  ...
  logoUrl: 'https://cdn.yflow.com/pieces/generatebanners.png',
