import { ApFile, LATEST_CONTEXT_VERSION, PieceAuth, Property } from '@yflow/pieces-framework'
import { FlowActionType, FlowTriggerType, GenericStepOutput, PropertyExecutionType, PropertySettings, StepOutputStatus } from '@yflow/shared'
...
describe('Props resolver', () => {
    ...
    it('should resolve files inside the array properties', async () => {
        const input = {
            documents: [
                {
                    file: 'https://cdn.yflow.com/brand/logo.svg?token=123',
                },
            ],
        }
        const props = {
