...
description: "Use your own OAuth2 credentials instead of the default Yflowapps"
icon: "lock"
---
...
When users connect to services like Google Sheets or Slack, they see "yflow" as the app requesting access. This works out of the box with no setup required.

## Why Replace OAuth2 Apps?

- **Branding**: Show your company name instead of "yflow" in authorization screens
