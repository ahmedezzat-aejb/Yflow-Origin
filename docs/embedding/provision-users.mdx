...
description: "Automatically authenticate your SaaS users to your Yflowinstance"
icon: 'user'
---
...
<Steps>
  <Step title="Step 1: Obtain Signing Key">
    ...
    This will generate a public and private key pair. The public key will be used by Yflowto verify the signature of the JWT tokens you send. The private key will be used by you to sign the JWT tokens.
  ...
  <Step title="Step 2: Generate a JWT">
    The signing key will be used to generate JWT tokens for the currently logged-in user on your website, which will then be sent to the YflowIframe as a query parameter to authenticate the user and exchange the token for a longer lived token.
    ...
    | role              | Role of the user in the Yflowproject (e.g., **EDITOR**, **VIEWER**, **ADMIN**)           |
