---
title: "SDK Changelog"
description: "A log of all notable changes to YflowSDK"
icon: "code-commit"
---
...
<Warning>
**Breaking Change:** <br></br> <br></br> If your Yflowimage version is < 0.45.0 and (you are using the connect method from the embed SDk, and need the connection externalId to be returned after the user creates it OR if you want to reconnect a specific connection with an externalId), you must upgrade your Yflowimage to >= 0.45.0
</Warning>
...
- This version requires you to **upgrade Yflowto [0.70.0](https://github.com/yflow/yflow/releases/tag/0.70.0)**.
...
- This version requires you to **upgrade Yflowto [0.66.7](https://github.com/yflow/yflow/releases/tag/0.66.7)**
...
- This version requires you to **upgrade Yflowto [0.66.1](https://github.com/yflow/yflow/releases/tag/0.66.1)**
...
- This version requires you to **upgrade Yflowto [0.64.2](https://github.com/yflow/yflow/releases/tag/0.64.2)**
...
- This version requires you to **upgrade Yflowto [0.64.0-rc.0](https://github.com/yflow/yflow/pkgs/container/yflow/438888138?tag=0.64.0-rc.0)**
...
- This version requires you to update Yflowto 0.56.0
...
- This version requires you to update Yflowto 0.41.0
- Adds the ability to pass font family name and font url to the embed sdk


### 26/01/2025 (0.3.3)

- This version requires you to update Yflowto 0.39.8
