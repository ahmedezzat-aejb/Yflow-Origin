...
This section provides an overview of how to embed the Yflowbuilder in your application and automatically provision the user.
...
<Steps>
    ...
    <Step title="Embed Builder">
        You can use the SDK to embed and customize Yflowin your SaaS, read more [here](./embed-builder).
    </Step>
</Steps>
