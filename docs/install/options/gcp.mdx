...
This documentation is to deploy Yflowon VM Instance or VM Instance Group, we should first create VM template
...
After a successful deployment, you can access the Yflowapplication by visiting the external IP address of the VM on GCP.
