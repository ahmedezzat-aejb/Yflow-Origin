...
**1. Clone Yflowrepository.**

Use the command line to clone Yflowrepository:
...
To upgrade to new versions, which are installed using docker compose, perform the following steps. First, open a terminal in the Yflowrepository directory and run the following commands.
