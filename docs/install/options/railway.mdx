---
title: "Railway"
description: "Deploy Yflowto the cloud in minutes using Railway's one-click template"
---

Railway simplifies your infrastructure stack from servers to observability with a single, scalable, easy-to-use platform. With Railway's one-click deployment, you can get Yflowup and running in minutes without managing servers, databases, or infrastructure.
...
The Railway template deploys Yflowwith the following components:

- **YflowApplication**: The main Yflowcontainer running the latest version from [Docker Hub](https://hub.docker.com/r/yflow/yflow)
...
Once deployed, Railway will provide you with a public URL where your Yflowinstance is accessible.

## Configuration

### Environment Variables

Railway allows you to configure Yflowthrough environment variables. You can set these in the Railway dashboard under your project's **Variables** tab.
...
To upgrade to a new version of Yflowon Railway:

1. Go to your Railway project dashboard
2. Navigate to **Deployments**
3. Click **Redeploy** on the latest deployment
4. Railway will pull the latest Yflowimage and redeploy
...
After deploying Yflowon Railway:
...
- [Architecture Overview](/install/architecture/overview): Understand Yflowarchitecture
