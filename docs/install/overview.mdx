...
YflowCommunity Edition can be deployed using **Docker**, **Docker Compose**, and **Kubernetes**.

<Tip>
Community Edition is **free** and **open source**.

You can read the difference between the editions [here](https://www.yflow.com/pricing).
</Tip>
...
Deploy Yflowas a single Docker container using the SQLite database.
  </Card>

  <Card title="Docker Compose" icon="layer-group" color="#00FFFF" href="./options/docker-compose">
    Deploy Yflowwith **Redis** and **PostgreSQL** setup.
  </Card>
...
<CardGroup cols={2}>
  <Card title="YflowCloud" icon="cloud" color="##5155D7" href="https://cloud.yflow.com/">
