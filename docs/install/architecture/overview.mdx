...
This page focuses on describing the main components of Yflowand focus mainly on workflow executions.
...
- **Webhooks**:
  All webhooks are sent to the Yflowapp, which performs basic validation and adds them to the queue. In case of a spike, webhooks will be added to the queue.
