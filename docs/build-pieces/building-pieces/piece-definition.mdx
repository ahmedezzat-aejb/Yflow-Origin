...
- [YflowLocal development](./development-setup) Or [GitHub Codespaces](../misc/codespaces).
- TypeScript syntax.
...
1. `Piece Name`: Specify a name for your piece. This name uniquely identifies your piece within the Yflowecosystem.
