...
import { pieceTranslation,PieceMetadata } from '@yflow/pieces-framework'
type SubPiece = {
    name: string;
    displayName: string;
    version: string;
...
export const AP_CLOUD_API_BASE = 'https://cloud.yflow.com/api/v1';
export const PIECES_FOLDER = 'packages/pieces'
export const COMMUNITY_PIECE_FOLDER = 'packages/pieces/community'
export const NON_PIECES_PACKAGES = ['@yflow/pieces-framework', '@yflow/pieces-common']
